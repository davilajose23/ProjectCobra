def add_custom_functions(fd):
    ...
    fd.add_var('a', 'double', 0.0, 1)
    fd.add_var('b', 'double', 0.0, 1)
    fd.add_var('c', 'double', 0.0, 1)
    fd.add_var('d', 'double', 0.0, 1)
    fd.add_var('size', 'int', 1, 1)
    fd.add_var('fill', 'string', '', 1)
    fd.add_var('line', 'string', '', 1)
    fd.update_function_params('a', 'double')
    fd.update_function_params('b', 'double')
    fd.update_function_params('c', 'double')
    fd.update_function_params('d', 'double')
    fd.update_function_params('size', 'int')
    fd.update_function_params('fill', 'string')
    fd.update_function_params('line', 'string')
